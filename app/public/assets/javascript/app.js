...
var budgetController = (function () {
    ...
    var Expense = function (sign, description, value) {
    ...
    var Income = function (sign, description, value) {
    ...
    return {
        addItem: function (type, desc, val) {
            ...
            if (data.allItems[type].length > 0) {
                ID = data.allItems[type][data.allItems[type].length - 1].sign + 1;
            } else {
                ID = 0;
            }
        ...
        deleteItem: function(type, sign) {
            ...
            // create a new array
            signs = data.allItems[type].map(function(currentElement){
